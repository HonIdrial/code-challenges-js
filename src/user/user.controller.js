module.exports = {
  isValidName: (req, res) => {
    ...
    //  3. Full first name and last name (Herbert Wells)
    //  3. Full first name, mid initial and last name (Herbert G. Wells)
    //  4. Initial and last name (H. Wells)
    const nameType1 = /^[A-Z]\.\s[A-Z][a-z]+$/;
    const nameType2 = /^[A-Z]\.\s[A-Z]\.\s[A-Z][a-z]+$/
    const nameType3 = /^[A-Z][a-z]+\s[A-Z][a-z]+$/
    const nameType4 = /^[A-Z][a-z]+\s[A-Z]\.\s[A-Z][a-z]+$/
    const nameType5 = /^[A-Z][a-z]+\s[A-Z][a-z]+\s[A-Z][a-z]+$/
    ...
    const isValidName = nameType1.test(req.params.name)
      ...
      || nameType5.test(req.params.name);
